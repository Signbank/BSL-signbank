...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.excludeFromEcv'
        db.add_column(u'dictionary_gloss', 'excludeFromEcv',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.excludeFromEcv'
        db.delete_column(u'dictionary_gloss', 'excludeFromEcv')
    ...
    models = {
        ...
        u'dictionary.gloss': {
            ...
            'excludeFromEcv': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
